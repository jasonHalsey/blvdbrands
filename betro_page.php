...
<div id="main-content" class="main-content">
	...
	<main>
		<section class="module_brand content_brand texture">
	      ...
	      <section class="module parallax_brand parallax-bs">
	        ...
	        <div class="container abbot_top texture-inverted">
	          ...
	          <div class="brand-info-container">
		          	<div class="brand-info">
			          	<a href="http://www.betrosimone.com"><img src="<?php bloginfo('template_directory'); ?>/images/brand/betro_brand_black.svg" class="svg" /></a><br />
			          	<a href="http://www.betrosimone.com">www.betrosimone.com</a>
		          	</div>
	          </div>
	        </div>
	      </section>
